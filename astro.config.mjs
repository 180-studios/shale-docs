			...
			sidebar: [
				...
				{ label: 'Upload via Plugin', collapsed: true, autogenerate: { directory: '03_Plugin_Upload' } },
				{
					...
					items: [
						...
						{ label: 'Brush Engine', link: '04_review/brush-engine' },
						{ label: 'Comments', link: '04_review/comments' },
						{ label: 'Highlighting', link: '04_review/highlighting' },
						{ label: 'Replying', link: '04_review/replying' },
						{ label: 'Camera Controls', link: '04_review/camera-controls' },
						{ label: 'Color', link: '04_review/color' },
						{ label: 'Versions', link: '04_review/versions' },
						{ label: 'View Notes', link: '04_review/view-notes' },
						{ label: 'View Annotations', link: '04_review/view-annotations' },
